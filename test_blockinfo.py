...
def single_tx_block():
    h_val = '000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'
    return BlockInfo(h_val)


@pytest.fixture(scope='module')
def multiple_tx_block():
    h_val = '0000000000000e102232eeb35175920438b8d8de12cab20f3e4d5b6e56dbca95'
    return BlockInfo(h_val)


def test_invalid_h_val():
    h_val = 'invalid000000e102232eeb35175920438b8d8de12cab20f3e4d5b6e56dbca95'
...
def test_avg_tx_value(single_tx_block, multiple_tx_block):
    ...
    assert math.isclose(multiple_tx_block.avg_tx_value,
                        39.65358258,
                        rel_tol=1e-8)
...
def test_tx_inputs(single_tx_block, multiple_tx_block):
    ...
    h_val = 'dce1b8cdb8cf06915c217c18fd28ffcbca90e70b280651302b2fdd47748ca25b'
    assert tx_input['hash'] == h_val
...
def test_tx_outputs(single_tx_block, multiple_tx_block):
    ...
    h_val = 'c81d11dd31a8f37824d81290a983b8d815fd17def166f3a4b722604639d70011'
    assert tx_output['hash'] == h_val
